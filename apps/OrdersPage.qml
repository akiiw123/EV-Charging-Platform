        ...
        ColumnLayout {
            ...
            AppCard {
                ...
                ColumnLayout {
                    ...
                    Text {
                        Layout.fillWidth: true; elide: Text.ElideRight; text: (appController.activeOrder.station_name || "当前充电站")
                              + " · "
            ...
            Repeater {
                ...
                delegate: AppCard {
                    ...
                    ColumnLayout {
                        ...
                        Text {
                            Layout.fillWidth: true; elide: Text.ElideRight; text: (modelData.station_name || "充电站")
                                  + " · "
