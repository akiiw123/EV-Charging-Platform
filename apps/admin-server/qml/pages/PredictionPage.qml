...
Item{id:root;Component.onCompleted:adminController.refreshPredictions()
    ColumnLayout{anchors.fill:parent;anchors.margins:24;spacing:16
        RowLayout{Layout.fillWidth:true;PageHeader{Layout.fillWidth:true;title:"智能预测";subtitle:"负荷趋势、空闲容量与高峰预警"}StatusBadge{status:adminController.predictionSource==="演示数据"?"warning":"active";label:adminController.predictionSource}AppButton{text:"刷新预测";variant:"secondary";onClicked:adminController.refreshPredictions()}}
        ...
        RowLayout{Layout.fillWidth:true;spacing:12
            MetricCard{Layout.fillWidth:true;label:"未来 1 小时";value:"短时负荷";trend:"模型预测"}
            MetricCard{Layout.fillWidth:true;label:"未来 6 小时";value:"班次负荷";trend:"模型预测";tone:"#9B87F5"}
            MetricCard{Layout.fillWidth:true;label:"未来 24 小时";value:"全天负荷";trend:"模型预测";tone:Theme.warning}
            MetricCard{Layout.fillWidth:true;label:"可信度";value:adminController.predictionSource==="演示数据"?"—":"90";unit:"%";trend:"置信区间";tone:Theme.success}
        }
