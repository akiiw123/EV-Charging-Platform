...
ScrollView{id:root;contentWidth:availableWidth;clip:true
    ...
    ColumnLayout{x:24;width:root.availableWidth-48;spacing:16
        ...
        GridLayout{Layout.fillWidth:true;columns:4;rowSpacing:12;columnSpacing:12
            ...
            MetricCard{Layout.fillWidth:true;label:"已完成订单(今日)";value:String(adminController.dashboard.completed_orders_today||0);unit:"单";trend:"只统计已完成订单";tone:Theme.warning}
            MetricCard{Layout.fillWidth:true;label:"平均订单金额";value:"¥ "+Number(adminController.dashboard.avg_order_amount||0).toFixed(2);trend:"累计客单价";tone:Theme.accent}
