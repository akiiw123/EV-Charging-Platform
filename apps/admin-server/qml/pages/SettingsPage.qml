/*
 * 文件职责：设置页：管理主题、动画、字号和表格偏好；持久化由 AdminAppController 完成。
...
AppScrollView{id:root;contentWidth:availableWidth;clip:true;property string previewTheme:adminController.theme
    ColumnLayout{x:24;width:root.availableWidth-48;spacing:18
        ...
        GridLayout{Layout.fillWidth:true;columns:3;columnSpacing:14;rowSpacing:14
            Repeater{model:[{id:"default",t:"默认信号蓝 Charging Light",c:["#F7F7F5","#FFFFFF","#2563EB"]},{id:"midnight",t:"深海青蓝 Midnight Cyan",c:["#07111F","#11223A","#18C8F4"]},{id:"aurora",t:"极光紫 Aurora Violet",c:["#0B1020","#171E35","#8B75FF"]},{id:"graphite",t:"石墨橙 Graphite Orange",c:["#121416","#202429","#F2A93B"]},{id:"emerald",t:"翡翠绿 Emerald Grid",c:["#071713","#112B23","#2ED39A"]},{id:"porcelain",t:"云白蓝 Porcelain Light",c:["#FBFAF6","#FFFFFF","#497596"]},{id:"contrast",t:"高对比 High Contrast",c:["#000000","#111111","#00E5FF"]}]
