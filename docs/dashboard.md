...
- 站内电子轨道（fx 层绘制）：电桩环绕站心排布在虚线轨道环上（半径按站 ID 从 0.09/0.115/0.14 三档派生，相邻多站呈同心电子壳层，环线互不穿插，均为示意布局非真实相对位置）；轨道虚线缓慢旋转，沿环公转的"电子"能量点数量 = 充电中桩数 + 1，环上随机闪过火花弧段（夜间亮金、日间橙红）模拟电流滋滋声；夜间另有桩点星辉光晕。
